/*
Listener to remove mobile menu when user clicks outside of menu
*/
$(function() { //$ function is the same as document.addEventListener("DOMContentLoaded"...)
  // $(string).blur is the same as documnet.querySelector("#navbarToggle").addEventListener("blur"...)
...
// Builds HTML for the categories page base don the data from the server
...
// Using categoriess data and snippets html
